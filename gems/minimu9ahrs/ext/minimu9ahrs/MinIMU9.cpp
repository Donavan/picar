...
Rice::Array MinIMU9::getRawMag()
{
  return array_from_ints(&compass.m);
}

Rice::Array MinIMU9::getRawAcc()
{
  return array_from_ints(&compass.a);
}

Rice::Array MinIMU9::getRawGyro()
{
  return array_from_ints(&gyro.g);
}

Rice::Array MinIMU9::getRawData()
{
  Rice::Array raw_array;
  raw_array.push(getRawMag());
  raw_array.push(getRawAcc());
  raw_array.push(getRawGyro());
  return raw_array;
}
